...
impl MapClusterer {
    pub fn cluster(&self, viewport: MapViewport) -> Result<MapViewportResult, String> {
        let result = self.inner.cluster(
            viewport
                .try_into()
