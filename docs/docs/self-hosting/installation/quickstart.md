...
New quickstarts use [Silo](https://github.com/pgsty/silo), a maintained MinIO fork, for local S3-compatible object storage; existing `my-ente/compose.yaml` files are unchanged.
