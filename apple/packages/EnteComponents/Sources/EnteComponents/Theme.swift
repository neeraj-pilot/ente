...
public struct EntePalette {
    ...
    static func make(app: EnteApp, scheme: ColorScheme) -> EntePalette {
...
public enum EnteMotion {
    ...
    public static let slow: TimeInterval = 0.26
}
...
public struct EnteTheme<Content: View>: View {
    ...
    public var body: some View {
        let palette = EntePalette.make(app: app, scheme: colorScheme)
        content
...
extension EnvironmentValues {
    public var entePalette: EntePalette {
...
private struct EntePaletteKey: EnvironmentKey {
    static let defaultValue = EntePalette.make(app: .photos, scheme: .light)
}
...
private enum EnteFont {
    ...
    private static let registration: Void = {
        for name in ["Inter-Regular", "Inter-Medium", "Inter-SemiBold", "Inter-Bold", "Outfit-SemiBold"] {
